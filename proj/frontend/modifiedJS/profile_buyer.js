...
function generate_item_html(item_imgurl, item_title, item_price, item_finish_time, item_seller_name, item_seller_address) {
...
function show_orders(response) {
    ...
    for (var index = 0; index < response.length; index++) {
        ...
        for (var ind = 0; ind < items.length; ind++){
            ...
            var item_content = generate_item_html(item_imgurl, item_title, item_price, item_finish_time, item_seller_name, item_seller_address);
